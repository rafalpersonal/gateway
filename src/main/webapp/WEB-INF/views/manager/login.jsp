...
<head>
	...
	<link href="${ctx }/static/metronic/media/css/login.css" rel="stylesheet" type="text/css"/>
...
<body class="login">
	<!-- BEGIN LOGO -->
	<div class="logo">		<!--  
		<img src="${ctx }/static/metronic/media/image/logo-bigs.png" alt="" /> 		-->		<h4 style="color: white;"> OneMillionGateways.com</h4>
	</div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" action="${ctx }/manager/j_spring_security_check" method="post">
			...
			<div class="control-group">
				...
				<label class="control-label visible-ie8 visible-ie9"><spring:message code="manager.login.account"/></label>
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" placeholder="<spring:message code="manager.login.account"/>" id="j_username" name="j_username"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label visible-ie8 visible-ie9"><spring:message code="manager.login.password"/></label>
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<input class="m-wrap placeholder-no-fix" type="password" id="j_password" placeholder="Password" name="j_password"/>
					</div>
				</div>
			</div>
	...
	<script src="${ctx }/static/metronic/media/js/jquery.validate.min.js" type="text/javascript"></script>
	<!-- END PAGE LEVEL PLUGINS -->
	<!-- BEGIN PAGE LEVEL SCRIPTS -->
	<script src="${ctx }/static/metronic/media/js/app.js" type="text/javascript"></script>
	<script src="${ctx }/static/metronic/media/js/login.js" type="text/javascript"></script>      
