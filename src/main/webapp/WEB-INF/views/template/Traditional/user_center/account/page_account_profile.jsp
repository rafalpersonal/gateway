  ...
  <body>
    ...
    <div class="container" style="min-height:400px; padding-top:50px;">
        ...
        <div class="col-sm-12 col-md-3 sidebar-offcanvas" id="sidebar" role="navigation">
          <jsp:include page="/module/sidebar/user_account.html?activeItem=0&styleType=${skins.sidebarSkin.styleType }" />
        </div><!--/span-->
        
        <div class="col-sm-12 col-md-7 col-md-offset-1">
          <jsp:include page="/module/portlet/account_profile.html?styleType=${skins.portletSkin.styleType }" />
        </div><!--/span-->
