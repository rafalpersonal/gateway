...
public class Example {
	...
	public void simulateGetUserTransactionHistory(String userId)
		...
		// - you need to start with a date, and then paginate based on the page
		// id
			...
			ParseException
	{
		...
		Example example = new Example("integration.subledger.com:83", "gateway", "boZ5KiX62qvNCPkv");
		
		// users deposited some money
		//example.simulateUserFundsReceived("1", "czh0526@sina.cn", "100", "89.90", "10.10");
		...
		//example.simulateGetUserTransactionHistory("czh0526@sina.cn");
	}
}
