...
import com.hongxu.ripple.gateway.federation.subledger.pnp.utils.Base64;
...
public class BaseClient {
	...
	public BaseClient(String host, String user, String password)
			throws MalformedURLException {
		this.host = host;
		this.user = user;
		this.password = password;
		this.readUrl = new URL("http://" + this.host + "/api/1/event/read");
		this.triggerUrl = new URL("http://" + this.host
				+ "/api/1/event/trigger");
	}

	public JSONObject read(String eventName, Map<String, Object> eventData)
			throws ClientException {
		return this.postEvent(this.readUrl, eventName, eventData);
	}

	public JSONObject trigger(String eventName, Map<String, Object> eventData)
			throws ClientException {
		return this.postEvent(this.triggerUrl, eventName, eventData);
	}

	protected JSONObject postEvent(URL url, String eventName,
			Map<String, Object> eventData) throws ClientException {
		...
		try {
			...
			conn.setRequestProperty("Authorization",
					"Basic " + Base64.encodeBytes(authString.getBytes()));
