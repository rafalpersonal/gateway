...
import com.hongxu.ripple.gateway.federation.subledger.pnp.org.json.JSONArray;
import com.hongxu.ripple.gateway.federation.subledger.pnp.org.json.JSONObject;
import com.hongxu.ripple.gateway.federation.subledger.pnp.to.Balance;
...
import com.hongxu.ripple.gateway.federation.subledger.pnp.to.Type;
import com.hongxu.ripple.gateway.federation.subledger.pnp.to.Value;
import com.hongxu.ripple.gateway.federation.subledger.pnp.utils.DateUtils;
...
public class Client extends BaseClient {
	...
	public Balance getUserBalance(String userId, Date at)
	...
	public Lines getUserTransactionHistory(String userId, Date date,
			String pageId, Integer perPage, Order order) throws ClientException {
		// prepare event data
		Map<String, Object> eventData = new HashMap<String, Object>();
		...
		for (int i = 0; i < jsonLines.length(); i++) {
			...
			lines.add(new Line(jsonLine.getString("id"), jsonLine
					.getLong("version"), jsonLine.getString("journal_entry"),
					jsonLine.getString("account"), jsonDateToDate(jsonLine,
							"posted_at"), jsonDateToDate(jsonLine,
							"effective_at"), jsonBalanceToBalance(jsonLine,
							"balance"), jsonValueToValue(jsonLine, "value"),
	...
	public String userFundsReceived(String transactionId, String referenceUrl,
			String description, String userId, String depositAmount,
			String userFunds, String gatewayFee) throws ClientException {
		Map<String, Object> eventData = new HashMap<String, Object>();
	...
	public String userRippleWalletFunded(String transactionId,
			String referenceUrl, String description, String userId,
			String amount) throws ClientException {
		Map<String, Object> eventData = new HashMap<String, Object>();
		eventData.put("transaction_id", transactionId);
		eventData.put("reference_url", referenceUrl);
		eventData.put("description", description);
	...
	public String bankToRippleWallet(String transactionId, String referenceUrl,
			String description, String amount) throws ClientException {
		Map<String, Object> eventData = new HashMap<String, Object>();
		eventData.put("transaction_id", transactionId);
		eventData.put("reference_url", referenceUrl);
		eventData.put("description", description);
	...
	public String userFundsTransferredOutOfBank(String transactionId,
			String referenceUrl, String description, String userId,
			String totalAmount, String transferAmount, String gatewayFee)
			throws ClientException {
		Map<String, Object> eventData = new HashMap<String, Object>();
		eventData.put("transaction_id", transactionId);
		eventData.put("reference_url", referenceUrl);
	...
	public String userFundsTransferredOffRippleNetwork(String transactionId,
			String referenceUrl, String description, String userId,
			String amount) throws ClientException {
		Map<String, Object> eventData = new HashMap<String, Object>();
		eventData.put("transaction_id", transactionId);
		...
		return this.trigger("user_funds_transferred_off_ripple_network",
				eventData).toString();
	}

	public String rippleWalletToBank(String transactionId, String referenceUrl,
			String description, String amount) throws ClientException {
		Map<String, Object> eventData = new HashMap<String, Object>();
		eventData.put("transaction_id", transactionId);
		eventData.put("reference_url", referenceUrl);
	...
	protected Date jsonDateToDate(JSONObject json, String key)
			throws ClientException {
	...
	protected Value jsonValueToValue(JSONObject json, String key) {
		...
		return new Value(jsonTypeToType(jsonValue, "type"), jsonAmountToAmount(
				jsonValue, "amount"));
	}
